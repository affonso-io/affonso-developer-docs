...
| `read:finder` | View Finder searches, results, and saved opportunities |
| `write:finder` | Start Finder searches and add or update saved opportunities |
| `delete:finder` | Delete saved Finder opportunities |
