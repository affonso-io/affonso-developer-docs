...
<ParamField body="email" type="string">
  Update the affiliate's email address. Must be a valid email format. Changes the program contact and Account email, not a merchant login User. If the email is already in use by another affiliate, the request will fail with a conflict error.
</ParamField>
