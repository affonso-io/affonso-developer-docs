...
<ResponseField name="marketplace_joined_at" type="string | null">
  ISO 8601 timestamp for when the program most recently joined the marketplace. `null` for listings created before this timestamp was recorded.
</ResponseField>
