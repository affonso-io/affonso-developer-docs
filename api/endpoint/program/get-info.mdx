...
<ResponseField name="website_url" type="string">
  Deprecated compatibility alias for the global promotion URL. Use [Promotion URLs](/api/endpoint/program/list-promotion-urls) for new integrations.
</ResponseField>
...
<ResponseField name="customer_information_visibility" type="string">
  Customer information that affiliates can see: `hidden`, `name`, `email`, or `name_and_email`.
</ResponseField>
