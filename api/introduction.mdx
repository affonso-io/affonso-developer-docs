...
The Affonso API allows you to programmatically manage your affiliate program. You can create affiliates, track referrals, send server-side conversions, manage commissions, and process payouts.
...
| [Conversions](/api-reference/endpoint/conversions/create) | Send server-side purchases and let Affonso calculate commissions automatically |
