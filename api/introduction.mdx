...
The Affonso API allows you to programmatically manage your affiliate program. You can create affiliates, track referrals, send server-side conversions and milestone events, manage commissions, and process payouts.
...
<a href="/api-reference/proxy-setup"> Proxy Setup (Optional)</a>.
</Info>
...
| [Source Adapters](/api-reference/endpoint/sources/create-event) | Forward upstream tool payloads through Affonso normalization |
