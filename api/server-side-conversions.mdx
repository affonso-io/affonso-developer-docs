...
description: 'Track backend purchases, milestone events, and refunds with Affonso'
---

## Overview

Use Affonso's server-side event endpoints when your backend already knows that
