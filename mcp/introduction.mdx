...
Affonso MCP provides **32 tools** across 6 domains:

| Domain | Tools | Description |
|--------|-------|-------------|
| [Affiliates](/mcp/tools/affiliates) | 6 | List, get, create, update, delete, and batch-update affiliates |
| [Referrals](/mcp/tools/referrals) | 5 | Track clicks, leads, and conversions |
| [Commissions](/mcp/tools/commissions) | 6 | Manage and batch-approve commission transactions |
| [Payouts](/mcp/tools/payouts) | 3 | Process and track affiliate payouts |
| [Finder](/mcp/tools/finder) | 7 | Search for affiliate opportunities and manage the team shortlist |
| [Creatives](/mcp/tools/creatives) | 5 | Manage Success Hub Creative Library assets |
...
Specify the format using the `response_format` parameter on any tool (`markdown` or `json`, default `markdown`). `responseFormat` is accepted as an alias.
