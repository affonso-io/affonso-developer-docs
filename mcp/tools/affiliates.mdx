...
The affiliate tools allow you to manage affiliates in your program through natural language commands. Create and update work on affiliate Accounts and durable program contacts, without creating merchant Users. All tools support both **Markdown** and **JSON** response formats.
...
Create a new affiliate in your program. Provisions an affiliate Account and durable program contact (no merchant User).
